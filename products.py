...
def product_form(window):
    global back_image
    product_frame = Frame(window,width=1130,height=567,bg='white')
    ...
    category_label = Label(left_frame,text='Category',font=('times new roman',14,'bold'),bg='white',fg='black')
    category_label.grid(row=1,column=0,padx=20,sticky='w')
    category_combobox = ttk.Combobox(left_frame,font=('times new roman',14,'bold'),state='readonly')
    category_combobox.grid(row=1,column=1,pady=18)
    category_combobox.set('Empty')

    supplier_label = Label(left_frame,text='Supplier',font=('times new roman',14,'bold'),bg='white',fg='black')
    supplier_label.grid(row=2,column=0,padx=20,sticky='w')
    supplier_combobox = ttk.Combobox(left_frame,font=('times new roman',14,'bold'),state='readonly')
    supplier_combobox.grid(row=2,column=1,pady=18)
    supplier_combobox.set('Empty')

    name_label = Label(left_frame,text='Name',font=('times new roman',14,'bold'),bg='white',fg='black')
    name_label.grid(row=3,column=0,padx=20,sticky='w')
    name_entry = Entry(left_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black')
    name_entry.grid(row=3,column=1,pady=18)

    price_label = Label(left_frame,text='Price',font=('times new roman',14,'bold'),bg='white',fg='black')
    price_label.grid(row=4,column=0,padx=20,sticky='w')
    price_entry = Entry(left_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black')
    price_entry.grid(row=4,column=1,pady=18)

    discount_label = Label(left_frame,text='Discount(%)',font=('times new roman',14,'bold'),bg='white',fg='black')
    discount_label.grid(row=5,column=0,padx=10,sticky='w',pady=(3,0))
    discount_spinbox = Spinbox(left_frame,from_=0,to=100,font=('times new roman',14,'bold'),width=19)
    discount_spinbox.grid(row=5,column=1,pady=(3,0))

    quantity_label = Label(left_frame,text='Quantity',font=('times new roman',14,'bold'),bg='white',fg='black')
    quantity_label.grid(row=6,column=0,padx=20,sticky='w')
    quantity_entry = Entry(left_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black')
    quantity_entry.grid(row=6,column=1,pady=18)

    status_label = Label(left_frame,text='Status',font=('times new roman',14,'bold'),bg='white',fg='black')
    status_label.grid(row=7,column=0,padx=20,sticky='w')
    status_combobox = ttk.Combobox(left_frame,values=('Active','Inactive'),font=('times new roman',14,'bold'),state='readonly')
    status_combobox.grid(row=7,column=1,pady=18)
    status_combobox.set('Select Status')
    ...
    add_button = Button(button_frame, text='Add', font=('times new roman', 12), width=10, cursor='hand2',
                           fg='red', bg='gold',command=lambda : add_product(category_combobox.get(),supplier_combobox.get(),name_entry.get(),
    ...
    update_button = Button(button_frame, text='Update', font=('times new roman', 12), width=10, cursor='hand2',
                        fg='red', bg='gold',command=lambda : update_product(category_combobox.get(),supplier_combobox.get(),name_entry.get(),
                                                                   price_entry.get(),discount_spinbox.get(),quantity_entry.get(),status_combobox.get(),treeview))
    ...
    delete_button = Button(button_frame, text='Delete', font=('times new roman', 12), width=10, cursor='hand2',
                        fg='red', bg='gold',command=lambda: delete_product(treeview,category_combobox,supplier_combobox,name_entry,price_entry,quantity_entry,status_combobox,discount_spinbox))
    ...
    clear_button = Button(button_frame, text='Clear', font=('times new roman', 12), width=10, cursor='hand2',
                        fg='red', bg='gold',command=lambda : clear_fields(category_combobox,supplier_combobox,name_entry,price_entry,quantity_entry,status_combobox,discount_spinbox,treeview))
    clear_button.grid(row=0, column=3, padx=8)

    search_frame = LabelFrame(product_frame,text='Search Product',font=('times new roman', 12,'bold'), width=10, cursor='hand2',
                        fg='black', bg='white')
    search_frame.place(x=480,y=30)

    search_combobox = ttk.Combobox(search_frame,values=('Category','Supplier','Name','Status'),state='readonly',width=16,font=('times new roman', 12))
    search_combobox.grid(row=0,column=0,padx=10)
    search_combobox.set('Search By')
    
    search_entry = Entry(search_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black',width=16)
    search_entry.grid(row=0,column=1)

    search_button = Button(search_frame, text='Search', font=('times new roman', 12), width=10, cursor='hand2',
                        fg='red', bg='gold',command=lambda : search_product(search_combobox,search_entry,treeview))
    ...
    show_button = Button(search_frame, text='Show All', font=('times new roman', 12), width=10, cursor='hand2',
                        fg='red', bg='gold',command=lambda : show_all(treeview,search_combobox,search_entry))
    show_button.grid(row=0, column=3, padx=8)

    treeview_frame = Frame(product_frame)
    treeview_frame.place(x=480,y=125,width=490,height=420)
