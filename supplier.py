...
def supplier_form(window):
    global back_image
    supplier_frame = Frame(window,width=1130,height=567,bg='white')
    ...
    invoice_label = Label(left_frame,text='Invoice No',font=('times new roman',14,'bold'),bg='white',fg='black')
    invoice_label.grid(row=0,column=0,padx=(20,40),sticky='w')
    invoice_entry = Entry(left_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black')
    invoice_entry.grid(row=0,column=1)

    name_label = Label(left_frame,text='Supplier Name',font=('times new roman',14,'bold'),bg='white',fg='black')
    ...
    contact_label = Label(left_frame,text='Supplier Contact',font=('times new roman',14,'bold'),bg='white',fg='black')
    contact_label.grid(row=2,column=0,padx=(20,40),sticky='w')
    contact_entry = Entry(left_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black')
    contact_entry.grid(row=2,column=1)

    description_label = Label(left_frame,text='Description',font=('times new roman',14,'bold'),bg='white',fg='black')
    description_label.grid(row=3,column=0,padx=(20,40),sticky='nw',pady=25)
    description_text = Text(left_frame,width=25,height=6,bg='lightyellow',fg='black',font=('times new roman',14,'bold'),bd=2)
    ...
    add_button = Button(button_frame, text='Add', font=('times new roman', 14), width=4, cursor='hand2',
                        fg='red', bg='gold',command=lambda : add_supplier(invoice_entry.get(),name_entry.get(),contact_entry.get(),
                                                                          description_text.get(1.0,END).strip(),treeview))
    add_button.grid(row=0, column=0, padx=20)

    update_button = Button(button_frame, text='Update', font=('times new roman', 14), width=4, cursor='hand2',
                        fg='red', bg='gold',command=lambda : update_supplier(invoice_entry.get(),name_entry.get(),contact_entry.get(),
                                                                          description_text.get(1.0,END).strip(),treeview))
    update_button.grid(row=0, column=1)

    delete_button = Button(button_frame, text='Delete', font=('times new roman', 14), width=4, cursor='hand2',
                        fg='red', bg='gold',command=lambda : delete_supplier(invoice_entry.get(),treeview))
    delete_button.grid(row=0, column=2, padx=20)

    clear_button = Button(button_frame, text='Clear', font=('times new roman', 14), width=4, cursor='hand2',
                        fg='red', bg='gold',command=lambda : clear_supplier(invoice_entry,name_entry,contact_entry,
    ...
    num_label = Label(search_frame,text='Invoice No',font=('times new roman',14,'bold'),bg='white',fg='black')
    num_label.grid(row=0,column=0,padx=(0,15),sticky='w')
    search_entry = Entry(search_frame,font=('times new roman',14,'bold'),bg='lightyellow',fg='black',width=12)
    search_entry.grid(row=0,column=1)

    search_button = Button(search_frame, text='Search', font=('times new roman', 14), width=4, cursor='hand2',
                        fg='red', bg='gold',command=lambda : search_supplier(search_entry.get(),treeview))
    search_button.grid(row=0, column=2,padx=15)

    show_button = Button(search_frame, text='Show All', font=('times new roman', 14), width=4, cursor='hand2',
                        fg='red', bg='gold',command=lambda : show_all(treeview,search_entry))
